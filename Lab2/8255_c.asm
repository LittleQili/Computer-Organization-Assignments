...
L1: 
		...
		ADD AL,0EH			;enable to light the first digit LED display
		OUT PortA,AL			;WRITE to PortA
		
		MOV AL,AH
		AND AL,0FH			;get the lower 4-bit of input(PC0~PC3)
		MOV BX,OFFSET SEGTAB
		ADD BL,AL			;calculate the addr of LED display input data
		MOV AL,[BX]			;read LED display input
		OUT PortB,AL			;WRITE to PortB
